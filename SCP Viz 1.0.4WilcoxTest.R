...
ui = navbarPage(
  ...
  title = "Single Cell Proteomics Vizualizer (SCP-Viz) 1.0.4", 
  ...
  tabPanel("Main",
           sidebarLayout(
             ...
             sidebarPanel(
               ...
               textInput("protein", "Enter Protein ID (Example: Human Histone H4 is P62805, Mouse is P62806)", value = ""),
               # Specifying the number of conditions.
               numericInput("num_conditions", "Number of Conditions (To merge conditions place 'or' between conditions)", value = 1, min = 1),
  ...
  tabPanel("User Guide",
           ...
           tags$ul(
             tags$li("Upload your SCP data file through the ", tags$b("Upload CSV File"), " button in the UI. You can get our test datasets at  https://github.com/orsburn/SCPViz ")
           ),
