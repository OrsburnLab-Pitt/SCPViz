...
required_packages <- c("shiny", "shinythemes", "plotly","FactoMineR", "factoextra", "imputeTS", "readxl", "ggplot2", "ggpubr", "readr", "dplyr", "tidyr", "gridExtra", "DT", "janitor","shinycssloaders")
...
ui = navbarPage(
  ...
  title = "Single Cell Proteomics Vizualizer (SCP-Viz) 1.0.5", 
           ...
           sidebarLayout(
             ...
             mainPanel(
               tabsetPanel(
                 ...
                 # PCA Plot moved to the bottom
                 tabPanel("PCA Plot (of all molecules in your input)", 
  ...
  tabPanel("User Guide",
           ...
           tags$ul(
             ...
             tags$li(tags$b("Individual Plots:"), " PCA, Bar, Box, Histogram, and Violin Plots are available. Please note that PCA plots are of all the data for all cells that you originally entered and this may require considerable time to complete.")
           ),
